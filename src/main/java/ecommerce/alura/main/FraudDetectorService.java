...
public class FraudDetectorService {
    ...
    public static void main(String[] args)
    {
        ...
        consumer.subscribe(Collections.singletonList("ECOMMERCE_NEW_ORDER")); //definir qual topico o consumidor vai escutar
        while (true)
        {
    ...
    private static Properties properties(){
        ...
        properties.setProperty(ConsumerConfig.CLIENT_ID_CONFIG, FraudDetectorService.class.getSimpleName() + "-" + UUID.randomUUID().toString());// definir nome da maquina que esta executando o consumer
        return properties;
    }
}
