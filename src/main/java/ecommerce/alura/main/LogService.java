...
public class LogService {
    ...
    public static void main(String[] args)
    {
        ...
        try(var service = new KafkaService(LogService.class.getSimpleName(), Pattern.compile("ECOMMERCE.*"),
                ...
                Map.of(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class.getName())))//configurado para deserializar com apenas string com a propriedade extra na KafkaService(MAP)
        {
            service.run();
        }
